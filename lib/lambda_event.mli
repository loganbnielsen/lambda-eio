(** Parsing helpers for common Lambda event-trigger envelope shapes. Each
    ...
    [*_of_json] in this codebase's AWS integrations (e.g. [dynamodb-eio]'s [Dynamodb_value]).
...
type dynamodb_stream_record = {
  ...
  keys : Yojson.Safe.t;  (** DynamoDB attribute-value JSON — decode with [dynamodb-eio]'s [Dynamodb_value.of_json] if needed *)
